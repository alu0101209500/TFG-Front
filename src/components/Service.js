            ...
            <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col s6 l3 center">
                    <a style={{marginTop: "32px"}} class="waves-effect waves-light btn">Enviar&nbsp;mensaje</a>
                  </div>
                  <div class="col s6 l3 center">
                    <a style={{marginTop: "32px"}} class="waves-effect waves-light btn">Solicitar&nbsp;servicio</a>
                  </div>
                </div>
